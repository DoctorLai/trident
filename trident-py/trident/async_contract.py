...
from trident.exceptions import DoubleSpending
from trident.abi import trx_abi
from trident import keys
import trident
...
class AsyncContract(object):
    ...
    def update_user_resource_percent(self, percent: int) -> "trident.async_tron.AsyncTransactionBuilder":
    ...
    def update_origin_energy_limit(self, limit: int) -> "trident.async_tron.AsyncTransactionBuilder":
    ...
    def clear_abi(self) -> "trident.async_tron.AsyncTransactionBuilder":
        """Clear contract ABI."""
        if self.origin_address != self.owner_address:
            raise RuntimeError("origin address and owner address mismatch")
...
class AsyncContractMethod(object):
    ...
    def with_owner(self, addr: str) -> "AsyncContractMethod":
        ...
        :meth:`TransactionBuilder.with_owner() <trident.async_tron.AsyncTransactionBuilder.with_owner>`.
        """
    ...
    async def call(self, *args, **kwargs) -> "trident.async_tron.AsyncTransactionBuilder":
    ...
    async def __call__(self, *args, **kwargs) -> "trident.async_tron.AsyncTransactionBuilder":
        """Call the contract method."""
        parameter = ""
...
class ShieldedTRC20(object):
    ...
    ) -> "trident.async_tron.AsyncTransactionBuilder":
